# Graph Report - ReEcap  (2026-08-18)

## Corpus Check
- 11 files · ~23,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 134 nodes · 197 edges · 25 communities (15 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d4e1a2e7`
...
Cohesion: 0.40
Nodes (5): buildSidebar(), closeResponsiveNavigation(), renderQuickLinksCard(), showIframe(), showOverview()
...
Cohesion: 0.40
Nodes (5): formatCurrencyAmount(), initResponsiveNavigation(), rebuildMainLayout(), renderDashboardCards(), updateOverviewCards()
