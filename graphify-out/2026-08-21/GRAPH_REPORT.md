# Graph Report - ReEcap  (2026-08-21)

## Corpus Check
- 13 files · ~34,232 words
...
- **What connects `THEME_STORAGE_DEFAULTS`, `script`, `manifest_version` to the rest of the system?**
